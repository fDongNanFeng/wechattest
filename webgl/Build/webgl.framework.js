...
function _WXCloseUDPSocket(instanceId) {
...
function _WXCreateUDPSocket(server, remotePort, localPort) {
...
function _WXSendUDPSocket(instanceId, bufferPtr, offset, length) {
 var instance = udpSocketManager.instances[instanceId];
 if (instance && instance.socket) {
...
function _WXShareFileBuffer(offset, callbackId) {
 window.WXWASMSDK.WXShareFileBuffer(HEAPU8, offset, _WXPointer_stringify_adaptor(callbackId));
}
...
function _WXUDPSocketSetOnClose(callback) {
 udpSocketManager.onClose = callback;
}

function _WXUDPSocketSetOnError(callback) {
 udpSocketManager.onError = callback;
}

function _WXUDPSocketSetOnMessage(callback) {
...
function _WX_CloseSocket(conf, callbackId) {
...
function _WX_GetLocation(conf, callbackId) {
...
function _WX_OnSocketClose() {
 window.WXWASMSDK.WX_OnSocketClose();
}

function _WX_OnSocketError() {
 window.WXWASMSDK.WX_OnSocketError();
}

function _WX_OnSocketMessage() {
 window.WXWASMSDK.WX_OnSocketMessage();
}

function _WX_OnSocketOpen() {
...
function _WX_SendSocketMessage(conf, callbackId) {
...
function _WX_StartGyroscope(conf, callbackId) {
...
function _WX_StopGyroscope(conf, callbackId) {
...
var asmLibraryArg = {
 ...
 "WXCloseUDPSocket": _WXCloseUDPSocket,
 ...
 "WXCreateUDPSocket": _WXCreateUDPSocket,
 ...
 "WXUDPSocketSetOnClose": _WXUDPSocketSetOnClose,
 "WXUDPSocketSetOnError": _WXUDPSocketSetOnError,
 "WXUDPSocketSetOnMessage": _WXUDPSocketSetOnMessage,
 ...
 "WX_CloseSocket": _WX_CloseSocket,
 ...
 "WX_GetLocation": _WX_GetLocation,
 ...
 "WX_OnSocketClose": _WX_OnSocketClose,
 "WX_OnSocketError": _WX_OnSocketError,
 "WX_OnSocketMessage": _WX_OnSocketMessage,
 "WX_OnSocketOpen": _WX_OnSocketOpen,
 ...
 "WX_SendSocketMessage": _WX_SendSocketMessage,
...
if (!Object.getOwnPropertyDescriptor(Module, "udpSocketManager")) Module["udpSocketManager"] = function() {
 abort("'udpSocketManager' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
